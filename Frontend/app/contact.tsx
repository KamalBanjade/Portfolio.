      ...
      <section className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-6 md:space-x-8">
        <div className="flex-1 ">
          ...
          <div className="max-w-6xl mx-auto sm:mx-0 text-[#8892b0] text-sm sm:text-base md:text-lg leading-relaxed">
            <p className="mb-4">
              I'm always eager to explore new opportunities and engage in exciting projects. Whether you have a question, a potential collaboration, or just want to connect, feel free to reach out! I'll make sure to respond as soon as I can.
            </p>
