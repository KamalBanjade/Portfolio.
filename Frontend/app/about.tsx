      ...
      <section className="flex flex-col sm:flex-row justify-center items-start space-y-6 sm:space-y-0 sm:space-x-6 md:space-x-8">
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-6 md:space-x-8 ">
            ...
            <div className="flex-shrink-0 w-full sm:w-auto flex justify-center md:justify-start sticky-container relative">
              <div className="w-48 h-48 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 overflow-hidden rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 sticky-image">
