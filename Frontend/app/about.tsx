    ...
    <div className=" max-w-6xl mx-auto bg-gradient-to-r from-[#0a192f] to-[#0a192f] hover:to-[#1a2f4f] rounded-lg p-4 sm:p-6 md:p-8 shadow-xl relative transition duration-500 ease-in-out transform md:hover:scale-100 lg:hover:scale-100 hover:translate-y-1" id="about">
      <section className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-6 md:space-x-8">
        <div className="flex-1 ">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-start lg:items-center lg:space-x-6 md:space-x-8">
            <div className="flex-1">
              <p className="text-[#8892b0] mb-4 leading-relaxed text-sm sm:text-base md:text-md">
              ...
              <p className="text-[#8892b0] mb-4 leading-relaxed text-sm sm:text-base md:text-md">This blend of technical expertise and creative passion defines who I am as a developer and a person, always striving to weave beauty, functionality, and innovation into the fabric of the web.
              </p>
            </div>
            <div className="flex-shrink-0 w-full lg:w-auto flex justify-center lg:justify-start mb-6 lg:mb-0">
              <div className="w-48 h-48 sm:w-48 sm:h-52 md:w-64 md:h-60 lg:w-60 lg:h-64 overflow-hidden rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 relative">
