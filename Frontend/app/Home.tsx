...
const Home: React.FC = () => {
    useEffect(() => {
        // Code inside this useEffect runs only on the client side
    ...
    return (
        <div className="container flex-1 flex flex-col justify-center items-start px-6 md:px-12 lg:px-20 text-left mt-8 p-4 sm:p-6 md:p-8">
            ...
            <h1 id="welcome" className="text-[#64ffda] text-3xl md:text-4xl lg:text-4xl font-bold mb-4" style={{ opacity: 0 }}>🚀 Welcome! I'm</h1>
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <Link href="#projects" passHref>
                    <button
                        ...
                        style={{ width: '156px', height: '50px' }} // Adjust the width and height as needed
                    >
                        View Projects
                    </button>
                </Link>
