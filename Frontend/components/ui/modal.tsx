  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      <div ref={modalRef} className="relative bg-white shadow-lg rounded-lg" style={{ width: imageDimensions.width, height: imageDimensions.height }}>
        <button
          onClick={onClose}
          className="absolute top-2 right-2 text-white rounded-full p-1 bg-teal-600 focus:outline-none transition-colors duration-300 close-button"
        >
          <AiOutlineClose className="text-xs lg:text-sm" />
